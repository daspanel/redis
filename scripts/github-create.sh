...
echo "Will create a new *$PRIVACYWORD* repo named daspanel-redis"
echo "on github.com in:"
echo "    user account: admindaspanel"
echo "    organization: daspanel"
echo "with this description:"
echo Docker image for Redis server used in the Dspanel project.
echo ""
...
curl -u admindaspanel https://api.github.com/orgs/daspanel/repos -d \
    "{\"name\": \"redis\", \"description\": \"Docker image for Redis server used in the Dspanel project.\", \"private\": $PRIVATE_TF}"
